...
$(document).ready(function () {
    ...
    $('.btn-verhabitacion').click(function (e) {
        ...
        var idReg = $(this).attr('data-rel');
        var nameReg = $(this).attr('data-rel2');
        var urlImg = $(this).attr('data-rel3');
        var obj = {a: 1, b: 2, c: 3, d: 4, e: 5};

        jQuery.each( obj, function( i, val ) {
            $( "#imagen" + val ).attr("src",urlImg+"/"+idReg+"/"+idReg+"-"+val+".jpg");
        });
    ...
    $('#cantkid').keyup(function (e) {
        ...
        if (cantidad != 0){
            ...
            for (i = 1; i <= cantidad; i++) { 
                newtr = newtr + "Edad: <input type='number' style='background-color: #EAE2D9' class='form-control' id='"+i+"' name='edadn"+i+"' required='' autocomplete='Off' />";
            }

            $('#edadnino').append(newtr);
        }
